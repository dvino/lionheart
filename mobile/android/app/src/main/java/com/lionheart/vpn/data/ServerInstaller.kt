...
class ServerInstaller {
    ...
    suspend fun install(
        ...
        try {
            ...
            val downloadUrl = "https://github.com/$GITHUB_REPO/releases/latest/download/lionheart-linux-$goArch"
            ...
            val dlResult = exec(session, "cd $INSTALL_DIR && curl -fsSL '$downloadUrl' -o lionheart.new && chmod +x lionheart.new && mv lionheart.new lionheart && echo OK")
